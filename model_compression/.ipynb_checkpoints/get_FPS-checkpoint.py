...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/mnt/workspace/NYU-CV-Fall2024-Project/yolov10/runs/prune/n-yolov8-nop234-gam-finetune2/weights/best.engine', help='trained weights path')
