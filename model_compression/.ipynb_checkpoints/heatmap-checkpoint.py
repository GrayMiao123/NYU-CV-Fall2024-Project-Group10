...
def check_weight_file(weight_path):
    if os.path.exists(weight_path):
        ...
        print("权重文件内容的键:", ckpt.keys())
        if 'model' in ckpt:
            print("模型属性:", dir(ckpt['model']))
    else:
...
if __name__ == '__main__':
    ...
    model(r'/mnt/workspace/yolov10/datasets/tt100k_2021/images/val/10009.jpg', 'result')
